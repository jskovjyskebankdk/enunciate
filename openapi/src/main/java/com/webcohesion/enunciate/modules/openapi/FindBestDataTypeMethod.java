 ...
 * @author Ryan Heaton
 */
public class FindBestDataTypeMethod extends Typed1ArgTemplateMethod<DataTypeReference, Entity> {
  public FindBestDataTypeMethod() {
    super(Entity.class);
  }
  
  protected DataTypeReference exec(Entity entity) {
    return findBestDataType(entity);
  }
